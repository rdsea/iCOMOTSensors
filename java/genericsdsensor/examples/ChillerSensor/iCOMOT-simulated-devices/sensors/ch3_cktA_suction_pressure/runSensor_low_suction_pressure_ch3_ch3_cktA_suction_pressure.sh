...
# This script can run standalone. For deploying it on gateway, please check the distribution version (in ./ch3_cktA_suction_pressure-distribution)
...
START OF DATA
id,name,time,ch3_cktA_suction_pressure
